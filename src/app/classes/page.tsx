...
export default async function ClassesPage({
  ...
  return withTenantSession(async (user) => {
    ...
    // Available levels for the level filter — only the ones that actually
    // exist in classes for this year, in canonical school order.
    const levelRows = await db.class.findMany({
